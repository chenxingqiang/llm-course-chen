# LLM Course Timeline: Famous SOTA LLM models and JAIS model
...
gantt
    ...
    The concept of the tokenizer and common types      :a6, 0, 1d
    ...
    Famous SOTA LLM models and JAIS model              :active,a10, after a9, 1d
    ...
    lesson 10 :active,l10, after l9, 1d
