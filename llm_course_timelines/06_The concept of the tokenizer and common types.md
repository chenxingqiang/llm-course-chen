# LLM Course Timeline: The concept of the tokenizer and common types
...
gantt
    ...
    The concept of the tokenizer and common types      :active,a6, after a5, 1d
    ...
    lesson 6  :active,l6, after l5, 1d
