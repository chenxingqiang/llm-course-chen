# LLM Course Timeline: Compose test cases for all public APIs
...
gantt
    ...
    Compose test cases for all public APIs             :active,a33, after a32, 1d
    ...
    lesson 33 :active,l33, after l32, 1d
