# LLM Course Timeline: Package the project as a Docker image / Conda environment and deploy it in the cloud
...
gantt
    ...
    Implement RAG proxy service                        :a30, after a29, 1d
    ...
    Package the project as a Docker image / Conda environment and deploy it in the cloud :active,a34, after a33, 1d
    section Lessons
    lesson 25 :l25, 0, 1d
